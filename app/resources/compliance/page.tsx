...
export const metadata: Metadata = {
  title: "C-Arm Compliance & Safety: Regulatory Requirements & Best Practices | C-ARMS.NET",
  description:
    "Complete guide to C-Arm compliance, FDA regulations, state requirements, radiation safety protocols, quality assurance, and operator training. Stay compliant and safe.",
}
